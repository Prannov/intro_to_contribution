...
useraddress=lbl=Label(window,text="DEBIT/CREDIT CARD:",font=("algerian",15,"italic"),fg="white",bg="black")
useraddress.place(x=150,y=355)

txtuser=Entry(window,font=("italics",15,"bold"))
txtuser.place(x=120,y=380,width=270)

userland=lbl=Label(window,text="ONLINE BANKING:",font=("algerian",15,"italic"),fg="white",bg="black")
